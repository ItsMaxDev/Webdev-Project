...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-sm-8 col-md-6 col-lg-5 col-xl-4 bg-dark-subtle p-4 rounded shadow">
            ...
            <p class="text-center text-secondary-emphasis">Don't have an account? <a class="text-secondary-emphasis" href="/account/signup">Sign up</a></p>
            <form method="post">
                ...
                <div class="form-group mb-4">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="text-secondary-emphasis text-decoration-none" href="/account/forgotpassword">Forgot Password?</a>
                    </div>
